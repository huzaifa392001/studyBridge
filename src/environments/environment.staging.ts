...
export const environment = {
    ...
    cookie: {
        ...
        expires: 30,
        path: '/',
        domain: 'staging.app.clinigro.com',
        secure: true,
        same_site: 'none',
    },
    ...
    app: 'client-portal',
    hostname: 'staging.app.clinigro.com',
    ...
    appUrl: 'https://staging.app.ismilelite.com',
    apiUrl: 'https://staging.clinigroapi.com',
    apiUrlFin: 'https://finance-stage.ctrld.io',
    apiUrlComs: 'https://coms-stage.ctrld.io',
